...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ContactList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String Message ;
                final UserData userData = (UserData) contactListAdapter.getItem(position);

                Message = "Do You Want To Remove " + userData.firstName +" From Contact List ?";
                ...
                RemoveContactDialog.setNegativeButton(R.string.edit, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int _id) {
                        startActivityToEditContact(userData.uid);
                    }
                });
    ...
    private ArrayList<UserData> getUpdatedContactList(){
        return new ArrayList<>(database.userDao().getAll()) ;
    }

    private void startActivityToAddContact(){
        Intent i = new Intent(this, DBEdit.class);
